...
static int init_Philothreads(){
    ...
    err(pthread_create((pthread_t*)&annaThread,NULL,routine,(struct philothread*)&Anna), "pthread create error",FATAL_ERROR);
 
    err(pthread_create((pthread_t*)&berndThread,NULL,routine,(struct philothread*)&Bernd), "pthread create error",FATAL_ERROR);
        
    err(pthread_create((pthread_t*)&claraThread,NULL,routine,(struct philothread*)&Clara), "pthread create error",FATAL_ERROR);
        
    err(pthread_create((pthread_t*)&dirkThread,NULL,routine,(struct philothread*)&Dirk), "pthread create error",FATAL_ERROR);
        
    err(pthread_create((pthread_t*)&emmaThread,NULL,routine,(struct philothread*)&Emma), "pthread create error",FATAL_ERROR);
